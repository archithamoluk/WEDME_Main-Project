...
<!-- /header -->
	...
	<div class="w3layouts-inner-banner">
		<div class="container">
			<div class="logo">
				<h1><a class="cd-logo link link--takiri" href="index.php"><span><i class="fa fa-heart" aria-hidden="true"></i>Made in heaven.</span></a></h1>
			</div>
	...
	<div class="w3_success-stories">
		<div class="container">
			...
			<div class="w3l_about_left col-md-6 text-center">
				<a href="#" data-toggle="modal" data-target="#myModal1"><img src="images/s1.jpg" alt=" " class="img-responsive" /></a>
				<div class="w3l_about_left_pos">
					<h3>Groom <span>& </span>Bride</h3>
				</div>
			</div>
			<div class="w3l_about_left col-md-6 text-center">
				<a href="#" data-toggle="modal" data-target="#myModal2"><img src="images/s2.jpg" alt=" " class="img-responsive" /></a>
				<div class="w3l_about_left_pos1">
					<h3>Groom <span>& </span>Bride</h3>
				</div>
			</div>
			<div class="w3l_about_left col-md-6 text-center">
				<a href="#" data-toggle="modal" data-target="#myModal3"><img src="images/s3.jpg" alt=" " class="img-responsive" /></a>
				<div class="w3l_about_left_pos">
					<h3>Groom <span>& </span>Bride</h3>
				</div>
			</div>
			<div class="w3l_about_left col-md-6 text-center">
				<a href="#" data-toggle="modal" data-target="#myModal4"><img src="images/s4.jpg" alt=" " class="img-responsive" /></a>
				<div class="w3l_about_left_pos1">
					<h3>Groom <span>& </span>Bride</h3>
				</div>
			</div>
