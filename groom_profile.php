...
<!-- /header -->
	...
	<div class="w3ls-list">
		...
		if(isset($_SESSION['login']))
		{
			...
			<?php
								$ret=select("select * from tbl_users where id='".$_REQUEST['id']."'");
				...
				<div class="w3layouts_details">
					...
					<?php
					$t=select("SELECT * FROM `tbl_interest` INNER JOIN tbl_users on tbl_interest.interested_id=tbl_users.id
					WHERE tbl_interest.userid='".$_SESSION['id']."' and tbl_interest.interested_id='".$_REQUEST['id']."'");
