...
?>
	...
	<div class="w3ls-list">
		<div class="container">
		<h2>Interested People's For You</h2>
		<div class="col-md-12 profiles-list-agileits">
			
			
				<div class="container" >
				<?php
				$res=select("SELECT * FROM `tbl_interest` INNER JOIN tbl_users on tbl_interest.userid=tbl_users.id 
				WHERE tbl_interest.interested_id='".$_SESSION['id']."'");
				
if(!mysqli_num_rows($res)>=1)
{
	
	?>
	  <div class="col-sm-8" style="background-color:lavender;font-weight:;font-size:25px;">No Interest Request Found!!!!!</div>
