...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | All Matches :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Matches</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<!-- featured profiles -->			
		...
		<div class="w3layouts_all-profiles">			
			<div class="container">
				<h3 class="w3_special">Total Matrimonial Profiles list</h3>
